    ...
    public edit(project: Project) {
        ...
        if (javaFunctions.trueOfFalse(this.showInOutputMapped)) {
            builder.and(new AddResourceInterfaceOneGetMethod(this.classNameMappedBy, this.classNameOther))
                ...
                .and(new AddFieldToSearchCriteria(this.classNameMappedBy, this.classNameOther, false))
        ...
        if (javaFunctions.trueOfFalse(this.showInOutputOther) && javaFunctions.trueOfFalse(this.biDirectional)) {
            builder.and(new AddResourceInterfaceOneGetMethod(this.classNameOther, this.classNameMappedBy))
                ...
                .and(new AddFieldToSearchCriteria(this.classNameOther, this.classNameMappedBy, true))
