...
export class AddResourcePutMethod extends EditFunction {
    ...
    private addUnitTests(project: Project, params: Params): void {

        const rawJavaMethod = ` 
        
    @Test
    public void testPut${this.otherClass}With${this.oneClass}_UpdateFailed() {

        when(${this.oneClass.toLocaleLowerCase()}Service.update${this.oneClass}With${this.otherClass}(${this.oneClass.toUpperCase()}_ID, ${this.otherClass.toUpperCase()}_ID)).thenReturn(false);

        ResponseEntity response = ${this.oneClass.toLocaleLowerCase()}Controller.put${this.otherClass}With${this.oneClass}(${this.oneClass.toUpperCase()}_ID, ${this.otherClass.toUpperCase()}_ID);
    ...
    @Test
    public void testPut${this.otherClass}With${this.oneClass}_UpdateSucces() {

        when(${this.oneClass.toLocaleLowerCase()}Service.update${this.oneClass}With${this.otherClass}(${this.oneClass.toUpperCase()}_ID, ${this.otherClass.toUpperCase()}_ID)).thenReturn(true);
