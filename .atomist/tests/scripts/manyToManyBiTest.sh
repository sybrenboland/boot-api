#!/usr/bin/env bash
rug generate shboland:boot-api:NewMavenProject manyToManyBiTest;
cd manyToManyBiTest;
...
rug edit shboland:boot-api:AddManyToManyRelation classNameMappedBy=Person classNameOther=Shop basePackage=org.shboland;
