...
Feature: Add Many-Many relation should add a relation between two beans
  ...
  Scenario: Add Many-Many relation should add a relation with no output of either class
    ...
    Then the combination changelog is extended with FK_CAR_PERSON_CAR of class Car and class Person_Car
    Then the combination changelog is extended with FK_PERSON_PERSON_CAR of class Person and class Person_Car
