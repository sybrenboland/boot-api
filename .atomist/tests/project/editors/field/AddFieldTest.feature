...
Feature: Add field class should add a given field to the api chain
  ...
  Scenario: AddField should add a basic field to the chain
    ...
    Then the name street is added to class JsonAdres in package entities of the Domain module
    Then the name Street is added to class AdresConverter in package convert of the Api module
    Then the name street is added to class JsonAdresSearchCriteria in package entities of the Domain module
  ...
  Scenario: AddField should add a date field to the chain
    ...
    Then the name createdDate is added to class JsonAdres in package entities of the Domain module
    Then the name CustomDateTimeSerializer is added to class JsonAdres in package entities of the Domain module
    Then the name CustomDateTimeDeserializer is added to class JsonAdres in package entities of the Domain module
  ...
  Scenario: AddField should abort if the type is not supported
    ...
    Then the name createdDate is not added to class JsonAdres in package entities of the Domain module
    Then the name CustomDateTimeSerializer is not added to class JsonAdres in package entities of the Domain module
    Then the name CustomDateTimeDeserializer is not added to class JsonAdres in package entities of the Domain module
