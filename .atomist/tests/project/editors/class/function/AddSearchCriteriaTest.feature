...
Feature: Add search criteria should add GET with search criteria to the api chain
  ...
  Scenario: AddSearchCriteria should add GET with search criteria
    ...
    Then a JsonSearchResult is added to Domain module in package entities
    Then a JsonAdresSearchCriteria is added to Domain module in package entities
    Then a AdresSearchCriteria is added to Persistence module in package criteria
    ...
    Then the test testList_withoutAdress is added to the integration tests of class Adres
